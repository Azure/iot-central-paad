import { CancellationToken, CommandCallback, FileUploadResult, HubCredentials, IIoTCClient, IIoTCLogger, IOTC_CONNECT, IOTC_EVENTS, IOTC_LOGGING, parseConnectionString, PropertyCallback, X509 } from "react-native-azure-iotcentral-client";
...
export class IoTCMock implements IIoTCClient {
    ...
    async connect(copts?: { cleanSession?: boolean | undefined; timeout?: number | undefined; cancellationToken?: CancellationToken | undefined; }): Promise<void> {
    ...
    on(eventName: string | IOTC_EVENTS.Properties, callback: PropertyCallback): void;
    ...
    async uploadFile(fileName: string, contentType: string, fileData: any, encoding?: string): Promise<FileUploadResult> {
